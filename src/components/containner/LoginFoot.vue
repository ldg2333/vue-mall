    ...
    <div class="container">
      <div class="footer-service">
        <ul class="list-service clearfix">
          ...
          <li><i class="el-icon-location-outline"></i>1000余家售后网点</li>
        </ul>
      </div>
      <div class="footer-copyright">
        <div class="clearfix" style="width: 32%;min-width: 456px;margin: 0 auto;padding: 10px 0">
          <el-image src="../../assets/img/logo.jpeg" :onerror="errorImage"></el-image>
          <div class="copyright">优购商城版权所有 ©2022-{{new Date().getFullYear()}}</div>
        </div>
      </div>
    </div>
  </div>
...
<script>
  export default {
    ...
    data() {
        return {
            errorImage:'this.src="' + require('../../assets/img/logo.jpeg') + '"'
        }
    },
  }
</script>
